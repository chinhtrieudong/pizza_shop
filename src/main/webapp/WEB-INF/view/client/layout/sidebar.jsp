                    ...
                    <div class="cart">
                        ...
                        <div class="cart-content">
                            <c:if test="${empty sessionScope.cartDetails}">
                                <div class="cart-content_notify alert alert-info text-center">Không có sản phẩm trong
                                    giỏ hàng</div>
                            </c:if>
                            <div class="cart-items">
                                <c:if test="${not empty sessionScope.cartDetails}">
                                    <c:forEach var="item" items="${sessionScope.cartDetails}" varStatus="status">
                        ...
                        <div class="cart-footer">
                            <div class="voucher-section text-center">
                                <div class="footer-btn_voucher">
                                    <button class="btn btn-voucher">SỬ DỤNG VOUCHER</button>
                                </div>
