                                        ...
                                        <div class="card checkout-card_item" style="padding: 30px 25px">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="receiverName" type="text" class="form-control"
                                                    id="formGroupExampleInput" value="${sessionScope.fullName}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput2">Số điện thoại*</label>
                                                <input name="receiverPhone" type="text" class="form-control"
                                                    id="formGroupExampleInput2" value="${sessionScope.phone}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput2">Email*</label>
                                                <input name="receiverEmail" type="text" class="form-control"
                                                    id="formGroupExampleInput2" value="${sessionScope.email}">
                                            </div>
                                        </div>
                                        <div class="card checkout-card_item" style="padding: 30px 25px">
                                            <div class="card-title">
