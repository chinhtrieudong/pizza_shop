                        ...
                        <div class="main-container container col-12 col-md-10 bg-light">
                            <nav aria-label="breadcrumb">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Delete combo</li>
                                </ol>
                            </nav>
                            ...
                            <div class="mt-5">
                                <div class="d-flex">
                                    ...
                                    <h3>Delete combo with id = ${combo.id}</h3>
                                </div>
                                <hr />
                                <div class="mt-3">
                                    <form:form method="POST" action="/admin/combo/delete" modelAttribute="combo">
                                        <form:input type="text" path="id" class="d-none" />
                                        <p>Bạn có chắc là muốn xóa combo này không?</p>
